...
__published:	// IDE-managed Components
	...
	TMenuItem *DeviceType1;
	TMenuItem *Initialization1;
	TMenuItem *Skin1;
	TMenuItem *Sky1;
	TMenuItem *Glow1;
	...
	void __fastcall DeviceType1Click(TObject *Sender);
	void __fastcall Initialization1Click(TObject *Sender);
	void __fastcall Sky1Click(TObject *Sender);
	void __fastcall Glow1Click(TObject *Sender);
	void __fastcall Windows101Click(TObject *Sender);
	void __fastcall ConFig2Click(TObject *Sender);
...
void __fastcall TForm1::WndProc(Winapi::Messages::TMessage &Message);  //最小化窗口判断
