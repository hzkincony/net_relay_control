	...
	: TForm(Owner)
{
   ...
   Form4->ComboBox9->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_2_1",  "不变" ) ;
   Form4->ComboBox10->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_2_2",  "不变" ) ;
   Form4->ComboBox11->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_2_3",  "不变" ) ;
   Form4->ComboBox12->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_2_4",  "不变" ) ;
   Form4->ComboBox13->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_2_5",  "不变" ) ;
   Form4->ComboBox14->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_2_6",  "不变" ) ;
   Form4->ComboBox15->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_2_7",  "不变" ) ;
   Form4->ComboBox16->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_2_8",  "不变" ) ;

   //----------------------载入第3路输入触发时，各路输出动作参数-------------

   Form4->ComboBox17->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_3_1",  "不变" ) ;
   Form4->ComboBox18->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_3_2",  "不变" ) ;
   Form4->ComboBox19->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_3_3",  "不变" ) ;
   Form4->ComboBox20->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_3_4",  "不变" ) ;
   Form4->ComboBox21->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_3_5",  "不变" ) ;
   Form4->ComboBox22->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_3_6",  "不变" ) ;
   Form4->ComboBox23->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_3_7",  "不变" ) ;
   Form4->ComboBox24->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_3_8",  "不变" ) ;

   //----------------------载入第4路输入触发时，各路输出动作参数-------------

   Form4->ComboBox25->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_4_1",  "不变" ) ;
   Form4->ComboBox26->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_4_2",  "不变" ) ;
   Form4->ComboBox27->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_4_3",  "不变" ) ;
   Form4->ComboBox28->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_4_4",  "不变" ) ;
   Form4->ComboBox29->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_4_5",  "不变" ) ;
   Form4->ComboBox30->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_4_6",  "不变" ) ;
   Form4->ComboBox31->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_4_7",  "不变" ) ;
   Form4->ComboBox32->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_4_8",  "不变" ) ;

   //----------------------载入第5路输入触发时，各路输出动作参数-------------

   Form4->ComboBox33->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_5_1",  "不变" ) ;
   Form4->ComboBox34->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_5_2",  "不变" ) ;
   Form4->ComboBox35->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_5_3",  "不变" ) ;
   Form4->ComboBox36->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_5_4",  "不变" ) ;
   Form4->ComboBox37->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_5_5",  "不变" ) ;
   Form4->ComboBox38->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_5_6",  "不变" ) ;
   Form4->ComboBox39->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_5_7",  "不变" ) ;
   Form4->ComboBox40->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_5_8",  "不变" ) ;

   //----------------------载入第6路输入触发时，各路输出动作参数-------------

   Form4->ComboBox41->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_6_1",  "不变" ) ;
   Form4->ComboBox42->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_6_2",  "不变" ) ;
   Form4->ComboBox43->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_6_3",  "不变" ) ;
   Form4->ComboBox44->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_6_4",  "不变" ) ;
   Form4->ComboBox45->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_6_5",  "不变" ) ;
   Form4->ComboBox46->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_6_6",  "不变" ) ;
   Form4->ComboBox47->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_6_7",  "不变" ) ;
   Form4->ComboBox48->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_6_8",  "不变" ) ;

   //----------------------载入第7路输入触发时，各路输出动作参数-------------

   Form4->ComboBox49->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_7_1",  "不变" ) ;
   Form4->ComboBox50->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_7_2",  "不变" ) ;
   Form4->ComboBox51->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_7_3",  "不变" ) ;
   Form4->ComboBox52->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_7_4",  "不变" ) ;
   Form4->ComboBox53->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_7_5",  "不变" ) ;
   Form4->ComboBox54->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_7_6",  "不变" ) ;
   Form4->ComboBox55->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_7_7",  "不变" ) ;
   Form4->ComboBox56->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_7_8",  "不变" ) ;

   //----------------------载入第8路输入触发时，各路输出动作参数-------------

   Form4->ComboBox57->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_8_1",  "不变" ) ;
   Form4->ComboBox58->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_8_2",  "不变" ) ;
   Form4->ComboBox59->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_8_3",  "不变" ) ;
   Form4->ComboBox60->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_8_4",  "不变" ) ;
   Form4->ComboBox61->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_8_5",  "不变" ) ;
   Form4->ComboBox62->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_8_6",  "不变" ) ;
   Form4->ComboBox63->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_8_7",  "不变" ) ;
   Form4->ComboBox64->Text  = ini->ReadString( "Trigger_Config_Run", "Trigger_8_8",  "不变" ) ;
