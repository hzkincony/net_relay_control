...
void __fastcall TForm3::Timer1Timer(TObject *Sender)
{
  ...
  week6=0;
  week7=0;
  control_flag1=control_flag2=control_flag3=0;  //最终继电器控制开关标志位
 ...
 //-------------------------第二路定时设置--------------------------------------
  ...
  //---------------------------------------------------------------------------
   ...
   if (control_flag2==1)
	{
	  Form1->Button3->Click();  //打开第一路开关
	}
  else
	{
	  Form1->Button4->Click();  //关闭第一路开关
	}
 ...
 //-------------------------第三路定时设置--------------------------------------
  ...
  //---------------------------------------------------------------------------
   ...
   if (control_flag3==1)
	{
	  Form1->Button5->Click();  //打开第一路开关
	}
  else
	{
	  Form1->Button6->Click();  //关闭第一路开关
	}
